...
function Initialize-PermissionCache {
    ...
    return [hashtable]::Synchronized(@{
            ...
            'ErrorByItemPath_DACL'         = New-PermissionCacheRef -Key $String -Value $String #hashtable Initialize a cache of errors generated by either Get-ACL or [System.Security.AccessControl.DirectorySecurity], depending on which was used.
