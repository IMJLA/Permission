...
function Initialize-PermissionCache {
    ...
    return [hashtable]::Synchronized(@{
            ...
            'ErrorByItemPath_Enumeration'  = New-PermissionCacheRef -Key $String -Value $String #hashtable Initialize a cache of errors generated by either Get-ChildItem or GetDirectories, depending on which was used.
            'ErrorByItemPath_AclRetrieval' = New-PermissionCacheRef -Key $String -Value $String #hashtable Initialize a cache of errors generated by either Get-ACL or [System.Security.AccessControl.DirectorySecurity], depending on which was used.
